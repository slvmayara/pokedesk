...
function insertPokemonHtml(pokemon) {
    ...
    <li class="pokemons-item">
     <div class="pokemons-card" data-pokemon-card-type-name="electric">
    ...
    <div class="pokemons-card-info">
        <h2 class="pokemons-card-name js-pokemon-card-name">
        ${pokemon.name}    
        </h2>
    ...
    <ul class="pokemons-card-attributes">
        ...
        <li class="pokemons-card-attributes-item">
            ...
            <div class="pokemons-card-attributes-progress">
                <div class="pokemons-card-attributes-progress-bar" style="width: ${attackStat.base_stat}%">
                </div>                            
            </div>
        </li>
        <li class="pokemons-card-attributes-item">
            ...
            <div class="pokemons-card-attributes-progress">
                <div class="pokemons-card-attributes-progress-bar" style="width: ${defenseStat.base_stat}%">
                </div>                            
            </div>
        </li>
        <li class="pokemons-card-attributes-item">
            ...
            <div class="pokemons-card-attributes-progress">
                <div class="pokemons-card-attributes-progress-bar" style="width: ${specialAttackStat.base_stat}%">
                </div>                            
            </div>
        </li>
    </ul>
...
function initFiltersFunction(pokemonsData){
    const filters = document.querySelectorAll(".pokemon-filter-list-button")
